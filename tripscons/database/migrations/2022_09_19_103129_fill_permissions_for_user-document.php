...
class FillPermissionsForUserDocument extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserDocument constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-document',
            'admin.user-document.index',
            'admin.user-document.create',
            'admin.user-document.show',
            'admin.user-document.edit',
            'admin.user-document.delete',
            'admin.user-document.bulk-delete',
        ]);
