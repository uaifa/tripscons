...
class FillPermissionsForDeviceBadge extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDeviceBadge constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.device-badge',
            'admin.device-badge.index',
            'admin.device-badge.create',
            'admin.device-badge.show',
            'admin.device-badge.edit',
            'admin.device-badge.delete',
            'admin.device-badge.bulk-delete',
        ]);
