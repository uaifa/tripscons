...
class FillPermissionsForTripMateInvitation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTripMateInvitation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.trip-mate-invitation',
            'admin.trip-mate-invitation.index',
            'admin.trip-mate-invitation.create',
            'admin.trip-mate-invitation.show',
            'admin.trip-mate-invitation.edit',
            'admin.trip-mate-invitation.delete',
            'admin.trip-mate-invitation.bulk-delete',
        ]);
