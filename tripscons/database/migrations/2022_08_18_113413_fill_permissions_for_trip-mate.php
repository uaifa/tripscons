...
class FillPermissionsForTripMate extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTripMate constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.trip-mate',
            'admin.trip-mate.index',
            'admin.trip-mate.create',
            'admin.trip-mate.show',
            'admin.trip-mate.edit',
            'admin.trip-mate.delete',
            'admin.trip-mate.bulk-delete',
        ]);
