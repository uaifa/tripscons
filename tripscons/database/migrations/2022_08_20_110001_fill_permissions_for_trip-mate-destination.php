...
class FillPermissionsForTripMateDestination extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTripMateDestination constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.trip-mate-destination',
            'admin.trip-mate-destination.index',
            'admin.trip-mate-destination.create',
            'admin.trip-mate-destination.show',
            'admin.trip-mate-destination.edit',
            'admin.trip-mate-destination.delete',
            'admin.trip-mate-destination.bulk-delete',
        ]);
