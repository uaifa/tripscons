...
class FillPermissionsForDeviceDetail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDeviceDetail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.device-detail',
            'admin.device-detail.index',
            'admin.device-detail.create',
            'admin.device-detail.show',
            'admin.device-detail.edit',
            'admin.device-detail.delete',
            'admin.device-detail.bulk-delete',
        ]);
