...
class FillPermissionsForBookingActivityLog extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBookingActivityLog constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.booking-activity-log',
            'admin.booking-activity-log.index',
            'admin.booking-activity-log.create',
            'admin.booking-activity-log.show',
            'admin.booking-activity-log.edit',
            'admin.booking-activity-log.delete',
            'admin.booking-activity-log.bulk-delete',
        ]);
