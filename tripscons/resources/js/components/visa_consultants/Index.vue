        ...
        <div class="row">
          <div class="col-12 col-sm-3">
            ...
            <div class="hotel-images">
                <div id="custom-slider">
                  ...
                  >
                  <router-link  :to="{path:'/visaConsultants/detail/'+genData.id}"  tag="img" :src="$imagePath+'visa_consultants/'+i.name"></router-link>
          ...
          <div class="col-12 col-sm-5">
            <div class="hotel-contentholder">
              ...
              >
                <router-link  :to="{path:'/visaConsultants/detail/'+genData.id}">
                <h3>{{ genData.experties.substr(0, 20) }}</h3>
                </router-link>
          ...
          <div class="col-12 col-sm-4">
            <div class="hotel-images">
              ...
              >
                ...
                <a :href="'/activities/detail/'+genData.id" class="btn btn-viewmap">View on map!</a>
              </div>
            </div>
          </div>
        </div>
 ...
 export default {
  ...
  methods: {
    ...
    getResults(page) {
      ...
      axios.post("/api/visaConsultant", bodyFormData).then((response) => {
      this.generalobjects = response.data.visaConsultants;
