  ...
  <main>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="banner-imag-parent">
              <div class="main-image" v-if="generalData.images && (generalData.images).length > 0">
                <template v-for="(main_img, index) in generalData.images">
                  ...
                  :src="$imagePath + 'meals/'+main_img.name" alt="img" />
                </template>
                  <button
                  class="editimages"
                  data-toggle="modal"
              ...
              :key="index"
                :src="$imagePath + 'meals/'+imge.name" alt="img" />
          ...
          >
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="images-wrapper">
                  ...
                  >
                    <img
                      v-if="slider_img.module == 'meals'"
                      :src="$imagePath + 'meals/' + slider_img.name"
                      alt="img"
                    />
                  </div>
                </div>
            ...
            <div class="home-details">
              <div class="media mb-4">
                ...
                <div class="media-body">
                  <h5 class="mt-0">Delivery charges</h5>
                  <p>{{ generalData.delivery_charges }}</p>
                </div>
              </div>
              ...
              <div class="media mb-4">
                ...
                <div class="media-body">
                  ...
                  <p>{{ generalData.food_preparation }}</p>
                </div>
              </div>
            </div>
            <div class="about-txt">
            ...
            <div class="custom-title mb-4">
              <h2 style="font-weight: 500">Ingredients</h2>
            </div>
            <div class="home-services">
              <ul>
                <li
                  v-for="(i, index) in generalData.meal_ingrediant"
                  :key="index"
                >
                  <span class="service-txt align-self-center"> {{ i.name }}</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-4 order-1 order-sm-2">
            ...
            <div class="d-flex mt-1 justify-content-start">
              <div>
                <p class="longright">
                  ...
                  <span class="ratingg"
                    >{{ userObj.rating }}
                    <span>({{ userObj.no_of_reviews }})</span></span
                  >
            ...
            <div class="d-flex justify-content-between mt-0">
              <p class="vehicle-rent-hour">Rs.{{ generalData.price }}</p>
              <p class="serving-title">
                {{ generalData.enough_for }} Persons serving
              </p>
            </div>
            <div class="d-flex justify-content-between mt-0">
              <p class="recipy-name">{{ generalData.brand }}</p>
              <strong>{{
            ...
            <div class="d-flex justify-content-between mt-0">
              ...
              <p class="delivery-time-value">{{ generalData.delivery_time }}</p>
            </div>
                  ...
                  <div class="modal-content pb-5">
                    <div class="modal-body">
                      <div class="recipy-wrapper">
                        <div class="recipy-item mt-4">
                          <div class="recipy-img">
                            <img
                              src="/assets/img/qorma2.jfif"
                              alt=""
                              srcset=""
                            />
                          </div>
                          ...
                          <div class="recipy-price">
                            <span>Rs.450</span>
                          </div>
                          <div class="recipy-serving">
                            <span>For 5 persons</span>
                          </div>
                          <div class="recipy-input">
                            <input type="checkbox" name="food" id="" />
                          </div>
                        </div>
                        <div class="recipy-item mt-4">
                          <div class="recipy-img">
                            <img src="/assets/img/pulao.jpg" alt="" srcset="" />
                          </div>
                          <div class="recipy-name">
                            <span>Pulao</span>
                          </div>
                        ...
                        <div class="recipy-item mt-4">
                          <div class="recipy-img">
                            <img src="/assets/img/bbq.jpg" alt="" srcset="" />
                          </div>
                          <div class="recipy-name">
                            <span>Bbq</span>
                          </div>
                        ...
                        <div class="recipy-item mt-4">
                          <div class="recipy-img">
                            <img src="/assets/img/pizza.jpg" alt="" srcset="" />
                          </div>
                          <div class="recipy-name">
                            <span>Pizza</span>
                          </div>
            ...
            <meal-booking :title="generalData.title" :des="generalData.description" :unit="generalData.unit"></meal-booking>
      ...
      <div class="location-sec">
        ...
        <p><i class="fa fa-map-marker"></i> {{generalData.location}}</p>
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                  <div class="host-name">
                    ...
                    <a href="#" class="btn btn-contacthost ripple"
                      >Contact host</a
                    >
                  </div>
                </div>
      ...
      <div class="stay-in-sec">
        <h3 class="title-section f-30">You might be interested in</h3>
        <div class="row">
          <div
            ...
            :key="index"
          >
            <router-link :to="{ path: '/meals/detail/' + i.id }">
              <div class="hotel-box">
                <div class="img-holder" v-if="i.single_image != null">
                  <img :src="$imagePath +'meals/'+ i.single_image.name" alt="hotel" />
                </div>
                <div class="img-holder" v-else>
                  <img :src="$imagePath + 'not-available.png'" alt="hotel" />
                </div>
                <div class="content-holder">
                  <p class="vehicle-model">{{ i.title }}</p>
                  <div
                    class="
                      d-flex
                  ...
                  <a href="#" class="btn btn-price"> Rs{{ i.price }} </a>
                </div>
              </div>
            </router-link>
          </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="images-wrapper">
            ...
            >
              <img
                v-if="slider_img.module == 'meal'"
                :src="$imagePath + slider_img.name"
                alt="img"
              />
            </div>
          </div>
...
export default {
  ...
  methods: {
    idGet() {
      axios.get("/api/mealDetail/" + this.Id).then((response) => {

        this.generalData = response.data.data;
        this.relatedData = response.data.data.relatedData;
        this.userObj = response.data.data.user;
        this.accCount = response.data.data.accommodationCount;
        this.transCount = response.data.data.transportCount;
        this.activityCount = response.data.data.activityCount;
        this.rules = response.data.data.rules;
      });
    },
    updateId() {
      this.Id = this.$route.params.mealId;
      this.idGet();
    },
  },
