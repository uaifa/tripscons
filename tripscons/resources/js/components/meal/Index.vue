        ...
        <div class="row">
          <div class="col-12 col-sm-3">
            ...
            <div class="hotel-images">
                <div id="custom-slider">
                  ...
                  >
                  <router-link  :to="{path:'/meals/detail/'+genData.id}"  tag="img" :src="$imagePath+'meals/'+i.name"></router-link>
          ...
          <div class="col-12 col-sm-5">
            <div class="hotel-contentholder">
              ...
              >
                <router-link  :to="{path:'/meals/detail/'+genData.id}">
              ...
              <div class="room-capi">
                {{ genData.enough_for}}  person serving<span aria-hidden="true"> · </span> 
              </div>
              
              <div class="price-div d-flex align-self-center">
              
                <a href = "#" class = "btn btn-price">
                 Rs.{{ genData.price }}/meal</a
                >
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-4">
            <div class="hotel-images">
              ...
              >
                ...
                <a :href="'/meals/detail/'+genData.id" class="btn btn-viewmap">View on map!</a>
              </div>
            </div>
          </div>
        </div>  
 ...
 export default {
  ...
  methods: {
    ...
    getResults(page) {
      ...
      axios.post("/api/meal", bodyFormData).then((response) => {
