          ...
          <div class="row">
            <div class="col-12 col-sm-8">
              ...
              <div class="banner-imag-parent">
                <div class="main-image">
                  ...
                  <button v-if="(generalData.images) && (generalData.images).length > 0" class="editimages" data-toggle="modal" data-target="#editdimages">
                    <span>
                      View Images
                    </span>
                  </button>
                ...
                <div class="center-images mt-2">
                  ...
                  <template v-if="!(generalData.images) || (generalData.images).length < 1"> 
              ...
              <div class="home-details home-details-edit">
                <!-- <i v-if="generalData.user_id == user_id" class="fa fa-pencil-alt" data-toggle="modal" data-target="#editFeatures"></i>
            ...
            <div  class="col-12 edit-parent col-sm-4">
              <div class="home-details-edits">
                <!-- <i v-if="generalData.user_id == user_id" class="fa fa-pencil-alt" data-toggle="modal" data-target="#editdetails"></i>
                  ...
                  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-zoom" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body p-4">
                          ...
                          <h5 class="mt-2">Do you offer free guide services?  </h5>
                        <div class="d-flex  ">
                ...
                <div  v-if="generalData.is_free_guide == 0" class="d-flex justify-content-between mt-2">
   ...
   <div class="modal-content">
     ...
     <div class=" py-3 mt-4 mb-5">
       ...
       <div class=" services-container-main custom-services-container  row">
        ...
        <div v-if="guideServices" v-for="(service, index) in guideServices" :key="'services_'+index" class="col-12 col-sm-4">
...
<h4>Services</h4>
 <div class="home-services mt-4">
            <ul v-if="servicesList && servicesList.length > 0">  
              <li v-if="servicesList" v-for="(service, index) in servicesList" :key="'service_lists_'+index">
   ...
   <div class="modal-content">
     ...
     <div class=" py-3 mt-4 mb-5">
       ...
       <div class=" services-container-main custom-services-container  row">
        ...
        <div v-if="optionsActivities" v-for="(activity, index) in optionsActivities" :key="'activities_'+index" class="col-12 col-sm-4">
...
<h4 class="mt-3">Activities </h4>
 <div class="home-services mt-4">
            <ul v-if="activitiesList && activitiesList.length > 0">
              <li v-if="activitiesList" v-for="(activity, index) in activitiesList" :key="'activities_list_'+index">
                <span class="service-icon align-self-center ">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading ">
                    ...
                    <h4 class="panel-title edit-parentt" data-toggle="collapse" data-target="#collapseTwo">
                      Cancellation policy
                      <!-- <i v-if="generalData.user_id == user_id" class="fa fa-pencil-alt" data-toggle="modal" data-target="#cancelhead"></i> -->
                ...
                <div class="panel panel-default">
                  <div class="panel-heading ">
                    ...
                    <h4 class="panel-title edit-parentt" data-toggle="collapse" data-target="#collapsePaymentTerms">
                      Payment Terms
                      <!-- <i v-if="generalData.user_id == user_id" class="fa fa-pencil-alt" data-toggle="modal" data-target="#payment_terms"></i> -->
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body  p-4">
                            <div class="form-group">
                              ...
                              <textarea name="payment_terms" id="" rows="3" v-model="formDatas.payment_terms" class="form-control">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading ">
                    ...
                    <h4 class="panel-title edit-parentt" data-toggle="collapse" data-target="#collapseThingsToKnow">
                      Things to know
                      <!-- <i v-if="generalData.user_id == user_id" class="fa fa-pencil-alt" data-toggle="modal" data-target="#things_to_know"></i> -->
...
export default {
  components: {
    ...
    methods:{
      ...
      getAllActivities(){
        axios.get('/api/getAllActivities').then((response) => {
        ...
        activityList() {
         ...
         getGuideDetail() {
                ...
                axios.get("/api/getGuidePackageDetail/" + this.Id).then((response) => {
        ...
        updateLanguageSection(){
          ...
          // if(!this.error){  
                ...
                axios.post("/api/guideUpdate/" + this.Id, bodyFormData).then((response) => {
                    if (response.status == 200) {
                      this.getGuideDetail();
