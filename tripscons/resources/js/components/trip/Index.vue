        ...
        <div class="row">
          <div class="col-12 col-sm-3">
            ...
            <div class="hotel-images">
                <div id="custom-slider">
                  ...
                  >
                  <router-link  :to="{path:'/trips/detail/'+genData.id}"  tag="img" :src="$imagePath+'trips/'+i.name"></router-link>
          ...
          <div class="col-12 col-sm-5">
            <div class="hotel-contentholder">
              ...
              >
                <router-link  :to="{path:'/trips/detail/'+genData.id}">
              ...
              <div class="room-capi">
                {{genData.min_members}} Min Persons<span aria-hidden="true"> · </span>
              </div>
              <ul class="hotel_icon">
                <li v-for="(f,index) in genData.trip_activity_four" :key="index">
                  <span class="icon"
                    ><img :src="'/assets/img/icons/'+f.image" alt="wifi"
                  /></span>
          ...
          <div class="col-12 col-sm-4">
            <div class="hotel-images">
              ...
              >
                ...
                <a :href="'/trips/detail/'+genData.id" class="btn btn-viewmap">View on map!</a>
              </div>
            </div>
          </div>
        </div>
 ...
 export default {
  ...
  methods: {
    ...
    getResults(page) {
      ...
      axios.post("/api/trip", bodyFormData).then((response) => {
