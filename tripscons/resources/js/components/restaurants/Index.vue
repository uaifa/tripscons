<template>
            ...
            >
                <div class="row">
                        ...
                        <div class="hotel-images">
                            <div id="custom-slider">
                                ...
                                >
                                    ...
                                    >
                                        <router-link  :to="{path:'/restaurants/detail/'+accommodation.id}"  tag="img" :src="$imagePath+i.name"></router-link>
                    ...
                    /></span>
                            ...
                            >
                                <router-link  :to="{path:'/restaurants/detail/'+accommodation.id}">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="hotel-images">
                            ...
                            >
                                ...
                                <a :href="'/restaurants/detail/'+accommodation.id" class="btn btn-viewmap">View on map!</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div v-if="getHotelsList.length > 0"
         class="hotel-list-box"
         v-for="(accommodation, index) in getHotelsList"
         :key="'hotels_'+index">
        ...
        <div class="row">
            <div class="col-12 col-sm-3">
                ...
                <div class="hotel-images">
                    <div id="custom-slider">
                        <router-link  :to="{path:'/restaurants/detail/'+accommodation.HotelCode+'/hotel/'}"  tag="img" :src="accommodation.HotelImage" style="width: 100%; height: 300px; object-fit: cover; border-radius: 17px;"></router-link>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-5">
                <div class="hotel-contentholder">
                    ...
                    /></span>
                                Top rated host</a
                            >
                            <small>{{ accommodation.HotelName }}</small>
                        </div>
                        <strong>{{ accommodation.HotelName +', '+accommodation.HotelName }}</strong>
                    </div>
                    <div
                        class="d-flex align-items-center justify-content-between mb-3"
                    >
                        <router-link  :to="{path:'/restaurants/detail/'+accommodation.HotelCode+'/hotel/'}">
                            <h3>{{ accommodation.HotelName.substr(0, 20) }}</h3>
                        </router-link>
                        <a href="#" class="rating-button">
                  <span class="rating align-self-center"
                  ><i class="fa fa-star"></i
                  ></span>
                            <span class="rating-title align-self-center">{{ parseFloat(accommodation.BestSellerRank).toFixed(1)}}</span>
                            <span class="count-rating align-self-center">(14)</span>
                        </a>
                    </div>
                    <div class="room-capi">
            ...
            <div class="col-12 col-sm-4">
                <div class="hotel-images">
                    ...
                    >
                        ...
                        <a :href="'/restaurants/detail/'+accommodation.HotelCode" class="btn btn-viewmap">View on map!</a>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
            ...
            getAvailableHotels(){
                axios.get("/api/available/hotels/").then((response) => {
        ...
        getResults(page) {
            ...
            axios.post("/api/restaurant", bodyFormData).then((response) => {
