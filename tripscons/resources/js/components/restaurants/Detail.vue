    ...
    <main>
      <div class="container">
          ...
          <div class="row">
            <div class="col-12 col-sm-8">
              <div class="row position-relative">
                <div v-if="type == 'hotel'" class="col-12">
                    <img style="width: 100%; height: 300px;" :src="getHotelDetails.HotelImage" alt="img" /> 
                </div>
                <span v-else>
                ...
                <div class="col-12 col-sm-8">
                  <div v-if="type != 'hotel'" class="larger-img-holder" data-toggle="modal" data-target="#image-slider" v-for="(main_img,index) in dataAcc.images" :key="index">
                    <img v-if="main_img.type=='main' && main_img.module=='trip'" :src="'/assets/uploads/'+main_img.name" alt="img" />
                  </div>
                  <div v-else class="larger-img-holder" data-toggle="modal" data-target="#image-slider">
                    <img :src="getHotelDetails.HotelImage" alt="img" />
                  </div>
                 
                </div>
                <div v-if="type != 'hotel'" class="col-12 col-sm-4">
                  <div class="center-img-holder" v-for="(imge ,index) in dataAcc.images" :key="index" data-toggle="modal" data-target="#image-slider">
                    <img v-if="imge.type=='normal' && imge.module=='trip'" :src="'/assets/uploads/'+imge.name" alt="img" />
                  </div>
                ...
                <div v-else class="col-12 col-sm-4">
                  <div class="center-img-holder" data-toggle="modal" data-target="#image-slider">
                    <img :src="getHotelDetails.HotelImage" alt="img" />
                  </div>
                  <!-- <div class="center-img-holder">
                    <img src="/assets/img/country-1.jpg" alt="img" />
            ...
            <div class="col-12 col-sm-4">
              <div class="hotel-title-sec">
                <h1 v-if="type != 'hotel'">{{ dataAcc.title }}</h1>
                <h1 v-else>{{ getHotelDetails.HotelName }}</h1>
              </div>
              <div class="d-flex mt-1 justify-content-start">
                <div>
                  <p class="longright">
                    <span>
                      <img class="starr" src="/assets/img/icons/star.png" width="25px" height="25px"/>
                    </span> 
                    <span v-if="type != 'hotel'" class="ratingg">
                      {{ dataAcc.id.toFixed(1)}} 
                    </span>
                    <span v-else class="ratingg">
                      {{ getHotelDetails.BestSellerRank}} 
                    </span>
                    <span>
                      (140)
                    </span>
              ...
              <div class="d-flex justify-content-between mt-0">
                <p v-if="type != 'hotel'" class="vila-title">
                  {{ dataAcc.trip_type}}
                </p>
                <p v-else>
                    {{ type }}
        ...
        <div class="card-container mt-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!--details-->
              <ul class="card-details my-2" 
              v-if="getHotelDetails.Offers" v-for="(offer, index) in getHotelDetails.Offers" :key="'offers_'+index">
                <li>{{ offer.CxlDeadLine }}</li>
                <li class="text-small">
                  {{ offer.Rooms[0] }} 
                  {{ offer.Rooms[1] }}
                </li>
                <li>{{ offer.RoomBasis }}</li>
                <li>
                  {{ offer.Availability == 1 ? 'Yes' : 'No' }}
                </li>
                <li> {{ offer.Currency }}.{{ offer.TotalPrice }}</li>
                <li>{{ offer.Category }}</li>
                <li class="text-small">
                  <span v-if="textType == 'more_'+index">
                    <p v-html="wordWrapText(offer.Remark, 1)"></p>
                      <span class="less-more" @click="showLessMoreText(index)"> 
                        Less
                      </span>
                    
                  </span>
                  <span v-else>
                    <p v-html="wordWrapText(offer.Remark)"></p>  
                      <span class="less-more" @click="showLessMoreText(index)"> 
                        More
                      </span>
        ...
        <div class="row">
          <div class="col-12 mt-4">
            ...
            <table class="table">
              ...
              <tbody>
                <tr v-if="getHotelDetails.Offers" v-for="(offer, index) in getHotelDetails.Offers" :key="'offers_'+index">
                  <!-- <th>{{ offer.HotelSearchCode }}</th> -->
                  <td>{{ offer.CxlDeadLine }}</td>
                  <td>
                    {{ offer.Rooms[0] }} <br>
                    {{ offer.Rooms[1] }}
                  </td>
                  <td>{{ offer.RoomBasis }}</td>
                  <li>
                  {{ offer.Availability == 1 ? 'Yes' : 'No' }}
                </li>
                <li> {{ offer.Currency }}.{{ offer.TotalPrice }}</li>
                  ...
                  <!-- <td>{{ offer.Preferred }}</td>   -->
                </tr>
                
              </tbody>
            </table>  
            <span v-if="getHotelDetails.Offers">
            <pagination
            :data="getHotelDetails.Offers"
        ...
        <div class="location-sec">
          ...
          <p><i class="fa fa-map-marker"></i> {{getHotelDetails.Location}}</p>
          <!-- <iframe
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
             ...
             <div class="images-wrapper">
              ...
              <img v-if="slider_img.module=='accommodation'" :src="'/assets/uploads/'+slider_img.name" alt="img" />
...
import {gmapApi} from 'vue2-google-maps'
 export default {
        ...
        methods:{
          wordWrapText(str, length=0){
            let strings = '';
            if(length == 0){
              strings = str.substring(0,50)
            }else{
              strings = str;
            }
            return strings;
          },
          showLessMoreText(index){
            if(this.textType == 'more_'+index){
              this.textType = '';
            }else{
              this.textType = 'more_'+index;
            }
          },
          accommodationGet(){
            ...
            axios.get("/api/tripDetail/"+accommodationId).then((response) => {
          ...
          getHotelDetail(){
            ...
            axios.get("/api/available/hotel/detail/"+this.Id).then((response) => {
