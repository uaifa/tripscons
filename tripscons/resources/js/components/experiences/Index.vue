        ...
        <div class="row">
          <div class="col-12 col-sm-3">
            ...
            <div class="hotel-images">
                <div id="custom-slider">
                  ...
                  >
                  <router-link  :to="{path:'/experiences/detail/'+genData.id}"  tag="img" :src="$imagePath+'experiences/'+i.name"></router-link>
          ...
          <div class="col-12 col-sm-5">
            <div class="hotel-contentholder">
              ...
              >
                <router-link  :to="{path:'/experiences/detail/'+genData.id}">
                ...
                <a href="#" class="rating-button">
                  ...
                  ></span>
                  <span class="rating-title align-self-center">{{ genData.rating.toFixed(1)}}</span>
          ...
          <div class="col-12 col-sm-4">
            <div class="hotel-images">
              ...
              >
                ...
                <a :href="'/experiences/detail/'+genData.id" class="btn btn-viewmap">View on map!</a>
              </div>
            </div>
          </div>
        </div>
 ...
 export default {
  ...
  methods: {
    ...
    getResults(page) {
      ...
      axios.post("/api/experiences", bodyFormData).then((response) => {
