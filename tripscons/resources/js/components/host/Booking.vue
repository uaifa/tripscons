            ...
            <div class="col-12 col-md-4">
              <div class="booking-profile-info">
                <div class="profile-info">
                  <div class="profile-info-avatar" v-if="detail.user.image !=null">
                        <img  :src="'/assets/uploads/users/' + detail.user.image" alt="" srcset="">
       ...
       <div class="booking-card">
        ...
        <div class="booking-list" v-for="(detail, index) in accommodationPastBooking"
                  ...
                  <div class="view-wrapper">
                    <img src="/assets/img/view.png" @click="loadBookingDetail(detail.id,detail.module_name)">
                  </div>
          <div class="row" >
            <div class="col-12 col-md-2"> 
              <div class="booking-profile" v-if="detail.accommodation.single_image !=null">
...
export default {
  ...
  methods: {
      ...
      axios.get("/api/getProviderBookingsForWeb/accommodations").then((response) => {
      this.accommodationDetail = response.data.data.data;
      this.accommodationPastBooking = response.data.pastBookings.data;
      });
    },
     loadMealsBooking() {
      axios.get("/api/getProviderBookingsForWeb/meals").then((response) => {
    ...
    loadExperiencesBooking() {
      ...
      axios.get("/api/getProviderBookingsForWeb/experiences").then((response) => {
    ...
    loadTransportsBooking() {  
      axios.get("/api/getProviderBookingsForWeb/transports").then((response) => {
