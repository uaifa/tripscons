          ...
          <div class="col-12 col-sm-3">
            ...
            <div class="hotel-images">
                <div id="custom-slider">
                  ...
                  >
                  <router-link  :to="{path:'/movieMakers/detail/'+accommodation.id}"  tag="img" :src="$imagePath+i.name"></router-link>
            ...
            <div class="hotel-contentholder">
              <div class="d-flex justify-content-between align-self-center">
                <div class="top-rated">
                  <a href="#" class="btn btn-ribbon">
                    ...
                    Top rated host</a
                  >
                  <small>{{ accommodation.tag_line }}</small>
                </div>
                <strong>{{ accommodation.tag_line +', '+accommodation.tag_line }}</strong>
              </div>
              <div
                class="d-flex align-items-center justify-content-between mb-3"
              >
                <router-link  :to="{path:'/movieMakers/detail/'+accommodation.id}">
                <h3>{{ accommodation.tag_line.substr(0, 20) }}</h3>
                </router-link>
              ...
              <div class="price-div d-flex align-self-center">
                <del class="align-self-center"
                  >From US {{ accommodation.hourly_rate }}$
                </del>
                <a href="#" class="btn btn-price">
                  <span>From</span> {{ accommodation.hourly_rate }} $</a
                >
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-4">
            <div class="hotel-images">
              ...
              >
                ...
                <a :href="'/activities/detail/'+accommodation.id" class="btn btn-viewmap">View on map!</a>
              </div>
            </div>
          </div>
        </div>
