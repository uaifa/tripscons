            ...
            <div class="search-filter-sec">
                        ...
                        <div v-show="ratingToggle" class="property-parent-div pro-rating">
                            ...
                            <div class="custom-control custom-radio">
                                <input
                                    ...
                                    name="rating"
                                    value="5"
                                    @change="accRating($event)"
                                    v-model="ratingCustom"
                                />
                            ...
                            <div class="btn-sec text-center d-flex">
                                <a href="#" class="btn btn-apply mr-1" @click="proRatingClear()"
                                >Clear</a
                                >
                                <a
                                    href="#"
              ...
              "
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <div class="btn-sec text-center d-flex">
                                <a href="#" class="btn btn-apply mr-1" @click="guestClear()"
                                >Clear</a
                                >
                                <a
                                    href="#"
                ...
                >
                    <div class="row">
                                ...
                                <div id="custom-slider">
                                    ...
                                    >
                                        ...
                                        >
                                            <router-link
                                                :to="{
                          path: '/accommodations/detail/' + accommodation.id,
                        }"
                                                tag="img"
                                                :src="$imagePath + 'accommodations/' + i.name"
                                            ></router-link>
                                        </SliderItem>
                                    </Slider>
                                </div>
                      ...
                      /></span>
                                            Top rated host</a
                                        >
                                        <small>{{ accommodation.type_name }}</small>
                                    </div>
                                    <strong>{{
                      ...
                      path: '/accommodations/detail/' + accommodation.id,
                                    ...
                                    >
                                        <h3>
                                            {{ accommodation.title.substr(0, 20) }}
                                        </h3>
                                    </router-link>
                    ...
                    /></span>
                                ...
                                <div class="price-div d-flex align-self-center">
                                    ...
                                    >From US {{ accommodation.per_night }}$
                                    </del>
                                    <a href="#" class="btn btn-price">
                                        <span>From</span>

                                        {{ accommodation.per_night - accommodation.discount}}
                                        $</a
                                    >
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="hotel-images">
                                ...
                                >
                                    <a
                                        :href="'/accommodations/detail/' + accommodation.id"
                                        class="btn btn-viewmap"
                                    >View on map!</a
                                    >
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        getResults(page) {
            ...
            axios.post("/api/accommodation", bodyFormData).then((response) => {
        ...
        facilities() {
            axios.get("/api/getAllFacilities?module_name=accommodations").then((response) => {
