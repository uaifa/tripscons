...
<div style="padding: 25px 0;"><strong style="font-size: 25px; color: #3d3d3d; text-transform: uppercase; font-weight: 600;">Booking Cancelled!</strong></div>
</td>
</tr>
...
<div class="order-detials-sec">This email is to inform you that your booking #{{$booking->booking_number}} has been canceled.</div>
<div class="order-detials-sec">&nbsp;</div>
