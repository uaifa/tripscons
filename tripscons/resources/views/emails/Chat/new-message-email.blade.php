...
<div class="pdf-logo" style="padding: 15px 0 15px; text-align: center; width: 100%; margin: 0 auto 15px;"><img src="https://staging.tripscon.com/assets/img/logo_white.png?tr=w-200" alt="logo" width="300px" /></div>
</td>
</tr>
<tr style="height: 78px;">
<td style="vertical-align: top; height: 78px; width: 1.53846%;" colspan="2">
<div style="padding: 25px 0;"><strong style="font-size: 25px; color: #3d3d3d; text-transform: uppercase; font-weight: 600;">New message from {{$data['sender']}}</strong></div>
</td>
</tr>
...
<div class="order-detials-sec">You have received a new message from {{$data['sender']}}</div>
<div class="order-detials-sec"><h2>Message</h2></div>
<div class="order-detials-sec">{{$data['message']}}</div>
<div class="order-detials-sec">&nbsp;</div>
