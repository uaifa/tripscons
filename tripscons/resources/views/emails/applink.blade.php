  ...
  >
    ...
    >
      ...
      >
            ...
            <h2 style="font-size:16px;font-weight:bold;">Get your Tripscon app link here.</h2>
       
      </div>

        <h4 style="font-size: 15px; font-weight: 500; margin: 20px 0px 10px">
        Thanks for using Tripscon app.
       
      </h4>
      <h4 style="font-size: 15px; font-weight: 500; margin: 20px 0px 10px">
       Please click on following link to download your app.
      </h4>
      <h6 style="font-size: 14px; font-weight: 400; margin: 20px 0px">
      
      Click here:  <a 
      href="{{config('app.url')}}install-app"
          style="
            font-size: 15px;
            color: #0a6cac;
