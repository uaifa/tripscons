...
<div style="padding: 25px 0;"><strong style="font-size: 25px; color: #3d3d3d; text-transform: uppercase; font-weight: 600;">{{$booking->title}}</strong></div>
</td>
</tr>
...
<div class="order-detials-sec">{{$booking->message}}</div>
<div class="order-detials-sec">&nbsp;</div>
