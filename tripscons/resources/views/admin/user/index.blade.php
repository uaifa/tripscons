                        ...
                        <div class="card-block" style="overflow-x: scroll !important;">
                            ...
                            <table class="table table-hover table-listing">
                                ...
                                <tr>
                                    ...
                                    <th is='sortable' :column="'address'">{{ trans('admin.user.columns.address') }}</th>
                                    ...
                                    <th is='sortable' :column="'date_of_birth'">{{ trans('admin.user.columns.date_of_birth') }}</th>
                                    <th is='sortable' :column="'is_profile_complete'">{{ trans('admin.user.columns.is_profile_complete') }}</th>
                                    <th is='sortable' :column="'is_phone_verified'">{{ trans('admin.user.columns.is_phone_verified') }}</th>
                                    <th is='sortable' :column="'languages'">{{ trans('admin.user.columns.languages') }}</th>
                                    <th is='sortable'>{{ trans('Id Card front') }}</th>

                                    <th></th>
                                </tr>
                                <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="43">
                                ...
                                <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                    ...
                                    <td>@{{ item.is_profile_complete }}</td>
                                    <td>@{{ item.is_phone_verified }}</td>
                                    <td>@{{ item.languages }}</td>
                                    <td>@{{ item.userDocument['front'] }}</td>
