...
class UsersController extends Controller
{
    ...
    public function index(IndexUser $request)
    {
        ...
        $data = AdminListing::create(User::class)->processRequestAndGet(
            ...
            ['id', 'name', 'type', 'email', 'phone', 'pin_code', 'country_code', 'postal_code', 'address', 'service_provider_type', 'gender', 'country', 'state', 'city', 'currency', 'lng', 'lat', 'social_platform', 'social_platform_id', 'device_type', 'device_token', 'role_id', 'verified', 'date_of_birth', 'is_mate', 'is_host', 'is_traveler', 'is_profile_complete', 'role_profile_id', 'rating', 'no_of_reviews', 'is_phone_verified', 'email_verified_at', 'phone_verified_at', 'languages', 'image', 'status', 'stripe_id', 'pm_type', 'pm_last_four', 'trial_ends_at'],

            // set columns to searchIn
            ['id', 'name', 'email', 'phone', 'pin_code', 'country_code', 'postal_code', 'address', 'service_provider_type', 'gender', 'country', 'state', 'city', 'currency', 'social_platform', 'social_platform_id', 'device_type', 'device_token', 'about', 'api_token', 'languages', 'image', 'user_module_type', 'stripe_id', 'pm_type', 'pm_last_four']
        );
    ...
    public function userDocIndex(IndexUser $request)
    {
        // create and AdminListing instance for a specific model and
        ...
        return view('admin.user.userProfile', ['data' => $data]);
    }
